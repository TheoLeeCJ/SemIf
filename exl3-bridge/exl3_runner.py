"""OpenJev-compatible direct-logit readout through exllamav3 (exl3 quantized models).

Same decision contract as openjev --mode direct:
  - prompt built with openjev core (system DIRECT_SYSTEM + JSON evidence/criterion/options)
...
if not _SRC.exists():  # standalone layout (openjev/ next to the bridge)
    _SRC = Path(__file__).resolve().parent.parent / "openjev" / "src"
sys.path.insert(0, str(_SRC))
from openjev_phase1.core import LETTERS, direct_messages, softmax, digest  # noqa: E402
